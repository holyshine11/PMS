...
public class HotelMapper {
    ...
    public PropertyResponse toResponse(Property property, long floorCount, long roomCount, long marketCodeCount) {
        return PropertyResponse.builder()
                ...
                .serviceChargeType(property.getServiceChargeType())
                ...
                .serviceChargeAmount(property.getServiceChargeAmount())
                .dayUseEnabled(property.getDayUseEnabled())
                .dayUseStartTime(property.getDayUseStartTime())
                .dayUseEndTime(property.getDayUseEndTime())
                .dayUseDefaultHours(property.getDayUseDefaultHours())
                .sameDayBookingEnabled(property.getSameDayBookingEnabled())
                .sameDayCutoffTime(property.getSameDayCutoffTime())
                .walkInOverride(property.getWalkInOverride())
